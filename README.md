...
## Test
```
	Test route to ensure connection between front-end and back-end. 
	./api/mylesSucks
```
...
## Built With 
* [React] (https://reactjs.org/) - Used to make frontend
* [Express] (https://expressjs.com/) - Used to make server
* [Node] (https://nodejs.org/en/) - Used to node
* [Mongo] (https://www.mongodb.com/) - Used for creating and hosting the database
* [Mongoose] (http://mongoosejs.com/) - Used for making the ORM for the database routes
